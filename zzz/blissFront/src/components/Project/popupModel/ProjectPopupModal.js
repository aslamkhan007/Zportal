...
const ModalPopup = (props) => {
    ...
    const displayEditData = () => {
        if (props.projectObj) {
            let { assignTo, startDate, dueDate, priority, watcher, estimate, workedOn, progress, riskStatus } = props.projectObj
    ...
    const onSubmit = (e) => {
        ...
        collapse["assignTo"] = collapse.assignTo.length
            ...
            : [];
        if (props.type === 'add') props.onProjectCreateSubmit(e, collapse)
        if (props.type === 'edit') props.onProjectEditSubmit(e, collapse)
    }
                        ...
                        <span className="row">
                            <span className="col-xl-9">
                                <Form.Group className="mb-2 col-xl-12 " controlId="formUser">
                                    <Form.Label className="ticket-light">PROJECT NAME</Form.Label>
                                    <Form.Control
                                        type="text"
                                        placeholder=""
                                ...
                                <Form.Group className="mb-2 col-xl-12 " controlId="formUser">
                                    ...
                                    <CKEditor
                                        initData={props.projectDescription}
                                        onChange={({ editor }) => {
                                            let htmlString = editor.getData();
                                            props.setProjectDes(htmlString);
                                        }}
                                    />
