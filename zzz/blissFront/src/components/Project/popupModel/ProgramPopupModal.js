...
import { Modal, Form, Button, Dropdown, Collapse } from "react-bootstrap";
import ShortIconn from "./../../../assets/images/iocn_toggle.png";
// import { createNotification } from "../../../Helper/helper";
import { NotificationContainer } from "react-notifications";
import { Loader } from "../../Loader/loader";
import { createTicketAction, getInvitedWorkspaceUsersAction, getWorkspaceAction } from "../../../redux/Action";
...
const ModalPopup = (props) => {
    ...
    const displayEditData = () => {
        ...
        let { assignTo, startDate, dueDate, priority, watcher, estimate, workedOn, progress, riskStatus } = props.programObj
        ...
        const collapseState = {
            assignTo,
            startDate: props.programObj.startDate ? moment(new Date(startDate)).toDate() : moment(new Date()).toDate(),
            dueDate: startDate ? moment(new Date(dueDate)).toDate() : moment(new Date()).toDate(),
            priority: priority,
            watcher: watcher,
            estimate: estimate,
            ...
            >
                ...
                <Modal.Body className="body_form row">
                  ...
                  <p className="error_mesage"> {errors.stage} </p>
                                ...
                                <Form.Group className="mb-2 col-xl-12 " controlId="formUser">
                                    <Form.Label className="ticket-light">PROGRAM NAME</Form.Label>
                                    <Form.Control
                                        type="text"
                                        placeholder=""
                                ...
                                <Form.Group className="mb-2 col-xl-12 " controlId="formUser">
                                    ...
                                    <CKEditor
                                        initData={props.programDescription}
                                        onChange={({ editor }) => {
                                            let htmlString = editor.getData();
                                            props.setDescription(htmlString);
                                        }}
                                    />
                                    {/* <CKEditor
                                        initData={<p></p>}
                                    ...
                                    {/* <Form.Control
                                        ...
                                        as="textarea" rows={2}
                                        placeholder=""
                                        value={props.programDescription}
