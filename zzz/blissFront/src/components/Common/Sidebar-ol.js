...
import { createProjectAction } from "../../redux/Action";
...
const Sidebar = (props) => {
  ...
  const [showEditProjectModalPopup, setShowEditProjectModalPopup] = useState(false);
  ...
  const isShowEditProjectPopup = (status, id, projectName) => {
  ...
  const listPrograms = (workspaceId) => {
  ...
  const toggleClass = () => {
    visible === "novisible" ? setvisible("visible") :setvisible("novisible");
  };
        ...
        <div className="child-bar addPopup">
          <h3 className="d-flex align-items-center justify-content-between sofia-semibold mb-3">
            ...
            <CreateProgram
              ...
              onProgramCreateSubmit={onProgramSubmit}
          ...
          <ul className="list-unstyled child-bar-list">
            {typeof props.sidebar != "undefined" && typeof props.sidebar.userBoard != "undefined" &&
              ...
              <>
                {programs && programs.length > 0 &&
                  programs.map((data, index_c) => (
                    <li key={"menu_p"} className={visible}>
                      <div className="child-bar-list-item d-flex align-items-center justify-content-between"  onClick={()=> toggleClass()}>
                        ...
                        <svg
                          ...
                          fill="none"
                          xmlns="http://www.w3.org/2000/svg"
                          onClick={() => isShowProjectPopup(true, data._id)}
                        >
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                          ...
                          {data.projects.map((child, index) => (
                            <li key={"menu_c" + index}>
                              <div className="d-flex align-items-center justify-content-between">
                                <Link to={`/programs/${child._id}`}>{child.projectCode + ' - ' + child.projectName}</Link>
                                <Dropdown>
                                  <Dropdown.Toggle
                                  ...
                                  <Dropdown.Menu align="right">
                                    <Dropdown.Item
                                      onClick={() => isShowEditProjectPopup(true, child._id, child.projectName)}
                                    >
                                      Rename
                                    </Dropdown.Item>
                                    <Dropdown.Item
                                    ...
                                    <Dropdown.Item onClick={() => isShowProgramPopup(true)}>
                                      New Program
                                    </Dropdown.Item>
                                    <Dropdown.Item onClick={() => isShowConfimPopup(true, child._id)}>
                                      Archive
                                    </Dropdown.Item>
                                    <Dropdown.Item onClick={() => isShowDeleteConfimPopup(true, child._id)}>
                                      Delete
                                    </Dropdown.Item>
                                  </Dropdown.Menu>
                                </Dropdown>
