...
import { listProjectAction } from "../../redux/Action";
...
const Sidebar = (props) => {
  ...
  const listProjects =()=>{
    const workspaceId = localStorage.getItem("userWorkspaceId");
    listProjectAction(workspaceId)
      .then((result) => {
  ...
  if (
    props.sidebar.sidebarSubTitle[0].link === "dashboard" &&
    props.sidebar.sidebarSubTitle[1].link &&
    props.sidebar.sidebarSubTitle[2].link === "dashboard-digital-transformation"
  ) {
    onGlass.push("active");
  } else {
    onGlass.push("");
  ...
  if (
    ...
    props.sidebar.sidebarSubTitle[5].link === "import"
  ) {
  ...
  const onProjectCreateSubmit = (e) => {
    ...
    if (isValid(e)) {
      const data = {
        ...
        workspaceId: localStorage.getItem('userWorkspaceId'),
      };
        ...
        <div className="child-bar addPopup">
          <h3 className="d-flex align-items-center justify-content-between sofia-semibold mb-3">
            ...
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              onClick={() => isShowProjectPopup(true)}
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
            ...
            <EditProject
              ...
              onProjectCreateSubmit={onProjectEditSubmit}
          ...
          <ul className="list-unstyled child-bar-list">
            <li key={"menu_p"}>
              ...
              {projects && projects.length > 0 ? (
                <ul className="list-unstyled">
                  {projects.map((child, index_c) => (
                    <li key={"menu_c" + index_c}>
                      <div className="d-flex align-items-center justify-content-between">
                        <Link to="">{child.projectName}</Link>
                        <Dropdown>
                          <Dropdown.Toggle
                          ...
                          <Dropdown.Menu align="right">
                            <Dropdown.Item onClick={()=> isShowEditProjectPopup(true)}>
                              Rename
                            </Dropdown.Item>
                            <Dropdown.Item onClick={() => isShowProjectPopup(true)}>
                              New Project
                            </Dropdown.Item>
            ...
            <li key={"menu_p"}>
              ...
              <ul>
                <li key={"menu_c"}>
                  <div className="d-flex align-items-center justify-content-between">
                    <Link to="">Data-centre Upgrade</Link>
                    <Dropdown>
                          <Dropdown.Toggle
                            className="p-0 bg-transparent border-0"
                            id="dropdown-basic"
                ...
                <li key={"menu_c"}>
                  <div className="d-flex align-items-center justify-content-between">
                    <Link to="">New System Migration</Link>
                    <Dropdown>
                          <Dropdown.Toggle
                            className="p-0 bg-transparent border-0"
                            id="dropdown-basic"
